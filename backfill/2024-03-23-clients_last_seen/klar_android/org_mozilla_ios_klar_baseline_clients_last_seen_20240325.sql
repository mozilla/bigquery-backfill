CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.backfills_staging_derived.org_mozilla_klar_baseline_clients_last_seen_20240325`
AS
SELECT
  ...
  *
FROM
  `moz-fx-data-shared-prod.backfills_staging_derived.org_mozilla_klar_derived_baseline_clients_last_seen_v1_20240322`