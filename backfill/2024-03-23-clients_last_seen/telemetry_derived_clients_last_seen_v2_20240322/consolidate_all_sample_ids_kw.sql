--create the table using the cluster order the original source tables have
...
--append sample IDs 0 - 99 - note: skipped running 60 - 69 for now because they look incomplete
